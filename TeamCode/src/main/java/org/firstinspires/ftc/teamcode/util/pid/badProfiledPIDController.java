...
public class badProfiledPIDController {
    ...
    public badProfiledPIDController(double Kp, double Ki, double Kd,
                                    MotionProfile.Constraints constraints) {
        m_controller = new PoofyPIDController.Builder().addPID(Kp, Ki, Kd).build();
        m_constraints = constraints;
    }

    public badProfiledPIDController(PoofyPIDCoefficients coeffs,
                                    MotionProfile.Constraints constraints) {
