...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double mecTransP = SampleMecanumDriveRR.TRANSLATIONAL_PID.kP;
        public double mecTransI = SampleMecanumDriveRR.TRANSLATIONAL_PID.kI;
        public double mecTransD = SampleMecanumDriveRR.TRANSLATIONAL_PID.kD;
        public double mecHeadingP = SampleMecanumDriveRR.HEADING_PID.kP;
        public double mecHeadingI = SampleMecanumDriveRR.HEADING_PID.kI;
        public double mecHeadingD = SampleMecanumDriveRR.HEADING_PID.kD;
        public double mecLateralMultiplier = SampleMecanumDriveRR.LATERAL_MULTIPLIER;
